...
// Log to console
console.log(message);
console.log("Por favor ejecute el archivo nodePlanas o en su defeto abra el archivo index.html en su navegador para ver los resultados de las figuras planas");