...
function resultadosEdades() {
    ...
    for (let i = 0; i < edades.length; i++) {
        if (edades[i] < 18) {
            ...
            adultosMayores.push(edades[i]);
        }
       
    }
    
    console.log('Menores de edad ingresados:', menoresDeEdad);
    console.log('Número Total de menores de edad:', menoresDeEdad.length);
    console.log('Adultos ingresados:', adultos);
    console.log('Total de Adultos ingresados:', adultos.length);
    console.log('Adultos mayores ingresados:', adultosMayores);
    console.log('Total de Adultos mayores ingresados:', adultosMayores.length);
